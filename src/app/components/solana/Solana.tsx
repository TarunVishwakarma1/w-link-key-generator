...
import { Button, Input, Card, CardBody, Snippet, CardHeader, CardFooter, useDisclosure, Modal, ModalHeader, ModalContent, ModalBody, ModalFooter } from '@nextui-org/react'
...
const Solana = (props: Props) => {
  ...
  const handleKeyGeneration = () => {
    ...
    setWallets(prevWallets => {
      const updatedWallets = [...prevWallets, keys]
          ...
          <Card className="relative p-4 rounded-lg shadow-md">
            <div
              className={`absolute inset-0 rounded-lg bg-gradient-to-r ${
                theme === 'dark'
                  ? 'from-gray-800 via-purple-900 to-gray-800'
                  ...
                  <ModalContent>
                    {(onClose) => (
                      <>
                        ...
                        <ModalBody>
                          <p>Are you sure you want to delete this wallet? This action is not reversible and you will lose access to your wallet.</p>
                          <p>Please make sure you have your keys and secret phrase with you for regeneration of the wallet in the future.</p>
                        </ModalBody>
                        <ModalFooter>
                ...
                <Input
                  ...
                  endContent={
                    <button
                      className="focus:outline-none"
                      type="button"
                      onClick={() => toggleVisibility(index, 'mnemonic')}
                      aria-label="toggle password visibility"
                    >
